...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      this.loadImage(this.backgroundImage).then(() => {
  ...
  data() {
    return {
      title:"Visa or not visa ?",
      backgroundImage:"https://images.pexels.com/photos/105238/pexels-photo-105238.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
    }
  },
